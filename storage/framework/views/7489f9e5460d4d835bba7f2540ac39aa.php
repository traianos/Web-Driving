;
<?php $__env->startSection('title','AdminLogin'); ?>;
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h1 class="text-center">AdminLogin</h1>
                </div>
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('AdminLogin.post')); ?>" method="POST" >
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\webdrivingschool\resources\views/admin/AdminLogin.blade.php ENDPATH**/ ?>