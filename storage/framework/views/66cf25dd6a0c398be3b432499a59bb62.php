            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a class="small" href="<?php echo e(route('resetpasss')); ?>">Forgot Password?</a>
                    </div>
                    <div class="text-center">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\webdrivingschool\resources\views/login.blade.php ENDPATH**/ ?>