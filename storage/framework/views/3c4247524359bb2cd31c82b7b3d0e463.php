<?php $__env->startSection('title','DrivingSchool'); ?>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo e(route('login')); ?>">Συνδεση</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo e(route('register')); ?>">Εγγραφη</a></li>
                        ...
                        <li class="nav-item">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="<?php echo e(route('car')); ?>">Δίπλωμα-Αυτοκίνητου</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('motor')); ?>">Δίπλωμα- Mοτοσυκλέτας</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('truck')); ?>">Δίπλωμα φορτηγού</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('bus')); ?>">Δίπλωμα Λεωφορείου</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('pei')); ?>">Δίπλωμα ΠΕΙ</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('adr')); ?>">Δίπλωμα ADR</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div style="text-align: center;">
                            ...
                            <img
                                decoding="async"
                                src="<?php echo e(asset('images/trucklogo.png')); ?>"
                    ...
                    <div class="carousel-item">
                        <div style="text-align: center;">
                            ...
                            <strong><img src="<?php echo e(asset('images/motologo.png')); ?>" alt="New Logo" style="width: 400px; height: auto; display: block; margin: 0 auto;"></strong>
                    ...
                    <div class="carousel-item">
                        <div style="text-align: center;">
                            ...
                            <strong><img src="<?php echo e(asset('images/carlogo.png')); ?>" alt="New Logo" style="width: 400px; height: auto; display: block; margin: 0 auto;"></strong>
                    ...
                    <div class="carousel-item">
                        <div style="text-align: center;">
                            ...
                            <strong><img src="<?php echo e(asset('images/buslogo.png')); ?>" alt="New Logo" style="width: 400px; height: auto; display: block; margin: 0 auto;"></strong>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="card-header">
                                                    <div>
                                                        <h4 class="card-title" style="font-family: Arial, sans-serif;">
                                                            <a href="<?php echo e(route('car')); ?>" style="color: white;">Δίπλωμα-Αυτοκίνητου</a>
                                                        </h4>
                                                    </div>
                                                </div>                                          
                                                <div class="card-body">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card text-center bg-success text-white">
                                                <div class="card-header">
                                                    <div>
                                                        <h4 class="card-title" style="font-family: Arial, sans-serif;">
                                                            <a href="<?php echo e(route('truck')); ?>" style="color: white;">Δίπλωμα φορτηγού</a>
                                                        </h4>
                                                    </div>
                                                </div>                                                  
                                                <div class="card-body">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card text-center bg-info text-white">
                                                <div>
                                                    <h4 class="card-title" style="font-family: Arial, sans-serif;">
                                                        <a href="<?php echo e(route('motor')); ?>" style="color: white;">Δίπλωμα-Mοτοσυκλέτας</a>
                                                    </h4>
                                                </div>                                    
                                                <div class="card-body">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card text-center bg-info text-white">
                                                <div class="card-header">
                                                    <h4><a href="<?php echo e(route('bus')); ?>" style="color: white;">Δίπλωμα-Λεωφορείου </a></h4>
                                                </div>
                                                <div class="card-body">
                                                    <h5 class="card-price">&euro;300</h5>
                                                    <p class="card-text">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card text-center bg-info text-white">
                                                <div class="card-header">
                                                  <h4>  <a href="<?php echo e(route('pei')); ?>" style="color: white;">Δίπλωμα-ΠΕΙ</a></h4>
                                                </div>
                                                <div class="card-body">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="card text-center bg-info text-white">
                                                <div class="card-header">
                                                   <h4> <a href="<?php echo e(route('taji')); ?>" style="color: white;">Δίπλωμα-ΤΑΞΙ</a></h4>
                                                </div>
                                                <div class="card-body">
                ...
                <div class="footer-content">
                    <div class="footer-about">
                        <div class="footer-about-logo">
                            <img src="<?php echo e(asset('images/driving.png')); ?>" alt="Driving School Logo" style="width: 300px; height: auto;">
                        </div>
                        <ul>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\webdrivingschool\resources\views/welcome.blade.php ENDPATH**/ ?>