...
<nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link btn btn-primary" href="{{ route('Dashboard') }}">back</a>
        </li>
    </ul>
</nav>
...
<div id="ΒιβλίαΘεωριας" style="display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(2, 1fr); gap: 10px; padding: 20px;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/book_autokinito-RedL.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/book_AYTOKINHTA.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
    ...
    <div style="text-align: center;">
        <h3>Μοτοσυκλέτα</h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/book_motosikleta-RedL-1.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/ΕΓΧΕΙΡΙΔΙΟ ΥΠΟΥΡΓΕΙΟΥ ΜΗΧΑΝΗΣ.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
    ...
    <div style="text-align: center;">
        <h3>Φορτηγό</h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/book_fortigo-RedL.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/book_FORTIGA_final.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
    ...
    <div style="text-align: center;">
        <h3>Λεωφορείο</h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/book_leoforeio-RedL.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/leoforeio.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
    ...
    <div style="text-align: center;">
        <h3>ΠΕΙ Φορτηγό </h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/book_fortigo_pei-RedL.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/manual_pei_fortiga.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
    ...
    <div style="text-align: center;">
        <h3>ΠΕΙ Λεωφορείο </h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/book_leoforeio_pei-RedL.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/pei_leoforeio.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
    ...
    <div style="text-align: center;">
        <h3>ADR</h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/book-ADR-RedL.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('books-pdf/Βιβλίο-ADR.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/Βιβλίο-Εξέτασης-ΤΑΞΙ.jpg')}}" alt="Image 1">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
                <a href="{{ asset('path/to/your/pdf/file1.pdf') }}" class="avia-button av-jpazy0n2-fc8d2c0b32b416f41f1dac02fef7d8fe avia-icon_select-yes-left-icon avia-size-x-large avia-position-center avia-color-theme-color-highlight" target="_blank" rel="noopener noreferrer" style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; display: inline-block;">
                    <span class="avia_button_icon avia_button_icon_left" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></span>
                    <span class="avia_iconbox_title">Download PDF 1</span>
                </a>
            </div>
...
<div id="Αιτήσεις" style="display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(2, 1fr); gap: 10px; padding: 20px;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/m-tao02-epektasi-a-b-be.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/m-tao03-epektasi-c-d.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/m-tao04-mi-xorigisis-pei.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/m-tao05-epektasi-diplomatos-se-ce-de.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
    ...
    <div style="text-align: center;">
        <h3>ΕΝΤΥΠΟ Αίτηση περί Μη χορήγησης ΠΕΙ</h3>
        <div class="image-container">
            <img src="{{ asset('pictures-images/m-tab-06-xorigisi-pei-arxiko.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/m-tao020-xorigisi-eidikis-adeias-taxi.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
    ...
    <div style="text-align: center;">
        ...
        <div class="image-container">
            <img src="{{ asset('pictures-images/aitisi-ektiposis-adeias-odigisis.jpg')}}" alt="Image 2">
            <div style="position: absolute; bottom: 0; left: 0; width: 100%; text-align: center;">
